...
args = parser.add_argument("-nsc", "--no_status_code", help="Specify status code rejected, example: -nsc 404 or -nsc 404,403", type=str)
...
def main():
    ...
    no_status_code = args.no_status_code
    threads = args.thread
    output = args.output
